...
public class Vista extends Parent {
    ...
    public void initcomponents() {
        ...
        setSize(n0, n1, n2, n3, n4, n5, n6, n7);
        setSize(n8, n9, mas, menos, multiplicar, dividir, reset, botonPunto);
        igual.setPrefSize(80, 80);

        aplicarManejador(n1, n2, n3, n4, n5);
        aplicarManejador(n6, n7, n8, n9, n0);
    ...
    private void aplicarManejador(Button n1, Button n2, Button n3, Button n4, Button n5) {
    ...
    private void setSize(Button n0, Button n1, Button n2, Button n3, Button n4, Button n5, Button n6, Button n7) {
